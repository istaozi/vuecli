  ...
  <div>
    ...
    >
      ...
      <template #exeStatus="obj">
        <el-tag v-if="obj.value==='200'" size="mini" type="success">{{ obj.value }}</el-tag>
        <el-tag v-else size="mini">{{ obj.value }}</el-tag>
      </template> </iips-table>
  </div>
</template>
